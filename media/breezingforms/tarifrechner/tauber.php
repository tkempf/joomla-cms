...
$tchecked=($iEx[0] == 1);
$tpreis=htmlentities(trim($iEx[1]), ENT_QUOTES, 'UTF-8');$tpreisbeschr='EUR/Jahr';
...
$tarbeitnt=($iEx[8] == 0) ? '' : 'Verbrauchspreis NT: '.htmlentities(trim($iEx[7]), ENT_QUOTES, 'UTF-8').' Cent pro kWh.<br>';
$tgrund='Grundpreis: '.htmlentities(trim($iEx[8]), ENT_QUOTES, 'UTF-8').' EUR pro Jahr';
$ttinhalt='<div class=\"bfToolTipLabel\"><b>Ihre Preisbestandteile ...</b><div/>'.$tarbeit.$tarbeitnt.$tgrund;
