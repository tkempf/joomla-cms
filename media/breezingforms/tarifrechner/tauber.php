...
$tslp=($iEx[9]==0) ? '' : '<tr><td class="whPreistitel">Mehr-/Mindermengenpreis<br>Stand '.$iEx[10].':</td><td class="whPreiszahl">&nbsp;<br>'.$iEx[9].'</td><td>&nbsp;<br>Cent pro kWh</td></tr>';
...
$tpreise='<div class="whPreisbestandteile"><p>Ihr Verbrauchspreis setzt sich wie folgt zusammen:</p><table>'.$tgrund.$tarbeitspreis.$tarbeitspreisnt.$tslp.$tbonus.'</table><p>Alle Preise verstehen sich inkl. derzeit gültiger Umsatzsteuer.</p></div>';
